            ...
            <div className='container text-[1.375rem]'>
                ...
                <div className='mb-7'>
                    ...
                    <ul className='list-disc ml-4'>
                        <li className='mb-3'>Minimum booking of 2 hours</li>
                        ...
                        <table className={`w-full border border-1`}>
                            ...
                            {data && data.noFee && Object.keys(data.noFee).map((key, index) => (
                                <tbody>
                                    ...
                                    {data.noFee[key].list.length && data.noFee[key].list.map((item, iItem) => {
                                        return (
                                            <tr key={iItem}>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-1 gap-3 text-[1.275rem] lg:text-[1.275rem]'>
                        <table className={`w-full border border-1`}>
                            ...
                            {data && data.EquipmentAddOns && Object.keys(data.EquipmentAddOns).map((key, index) => (
                                <tbody>
                                    <tr key={index}><td className='p-3 border border-b-1 bg-[#ddd] text-center font-RanuaTrialsBold' colSpan={3}>{data.EquipmentAddOns[key].title}</td></tr>
