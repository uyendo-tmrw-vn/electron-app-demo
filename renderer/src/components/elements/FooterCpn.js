      ...
      <div className='container lg:pt-[3.125rem] py-[3.125rem]'>
        ...
        <div className='flex flex-col lg:flex-row pb-[2.5rem] border-b border-[#717170]'>
          <div className='w-full sm:w-1/5 flex flex-col max-w-[100%] lg:max-w-[32%] mb-[20px] lg:mb-0'>
            <a onClick={() => handleClickToAbout()} className='text-[1.375rem] lg:text-[0.875rem] hover:text-[#000] hover:underline font-RanuaTrialsBold mb-[15px]'>About</a>
            <Link href="">
              <a onClick={(e) => handleLinkToPage(e, '/work', router)} className='text-[1.375rem] lg:text-[0.875rem] hover:text-[#000] hover:underline font-RanuaTrialsBold mb-[15px]'>Work</a>
            </Link>

          </div>
          <div className='w-full sm:w-1/5 flex flex-col max-w-[100%] lg:max-w-[32%] mb-[20px] lg:mb-0'>
            <Link href="">
              <a  onClick={(e) => handleLinkToPage(e, '/booking', router)} className='text-[1.375rem] lg:text-[0.875rem] hover:text-[#000] hover:underline font-RanuaTrialsBold mb-[15px]'>Reservations</a>
            </Link>
            <a onClick={() => handleClickToContact()} className='text-[1.375rem] lg:text-[0.875rem] hover:text-[#000] hover:underline font-RanuaTrialsBold mb-[15px]'>Contact Us</a>
            {/* <Link href="/">
        ...
        <div className='flex mt-[20px] justify-between items-baseline sm:flex-row flex-col'>
          <div className='flex lg:flex-row flex-col mb-7 md:mb-0'>
            <Link href="">
              <a onClick={(e) => handleLinkToPage(e, '/terms', router)} className='text-[1.375rem] lg:text-[0.875rem] mr-[3.75rem] hover:text-[#000] hover:underline font-RanuaTrialsBold mb-[15px]'>Terms and Conditions</a>
            </Link>
            <Link href="">
              <a onClick={(e) => handleLinkToPage(e, '/privacy', router)} className='text-[1.375rem] lg:text-[0.875rem] mr-[3.75rem] hover:text-[#000] hover:underline font-RanuaTrialsBold mb-[15px]'>Privacy Policy</a>
            </Link>
            {/* <Link href="/">
          ...
          <div className='flex'>
            ...
            <div className='flex'>
              <Link href="">
                <a onClick={(e) => handleLinkToPage(e, 'https://www.instagram.com/Fiction.SG/', router)} target='_blank' className='mx-[2px] mt-[2px] flex items-center'><img  alt='Fiction' src='/images/social-ins.jpg' className="w-full" /></a>
              </Link>
              <Link href="">
                <a onClick={(e) => handleLinkToPage(e, 'https://www.facebook.com/fictionsg/', router)} target='_blank' className='mx-[2px] mt-[2px] flex items-center'><img  alt='Fiction' src='/images/social-fb.jpg' className="w-full" /></a>
              </Link>
              {/* <Link href="/">
