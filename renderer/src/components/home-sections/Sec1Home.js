...
const Sec1Home = () => {
    ...
    return (
        <section ref={homeRef} id="homeContainer" className='home-section-1 relative' >
            ...
            <Slider  {...settingsSlider} className={`${isHide ? 'opacity-0 h-0 overflow-hidden' : 'opacity-1 h-full'} transition-all homeSlider h-[85vh] lg:h-screen bg-no-repeat bg-cover bg-left`}  >
